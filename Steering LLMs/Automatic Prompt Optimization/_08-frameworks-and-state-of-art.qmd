...
![SAMMO symbolic prompt program overview. Source: Ribeiro et al. (2024).](Automatic Prompt Optimization/images/sammo-overview.png){#fig-sammo}

![SAMMO headroom analysis showing where structural prompt transformations matter most. Weaker models benefit more from structural optimization, and RAG pipelines show the most headroom. Source: Ribeiro et al. (2024).](Automatic Prompt Optimization/images/sammo-headroom.png){#fig-sammo-headroom}
