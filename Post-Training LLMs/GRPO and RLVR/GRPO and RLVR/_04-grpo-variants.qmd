...
![DAPO's entropy and accuracy curves compared to GRPO baselines. The Clip-Higher strategy maintains higher entropy throughout training, preventing the collapse that limits exploration in vanilla GRPO. Source: Yu et al. (2025).](images/dapo-entropy.png){#fig-dapo-entropy}
...
![The REINFORCE++ architecture. Unlike GRPO, it uses a global baseline across the batch rather than per-question group statistics. Source: Hu et al. (2025).](images/reinforce-plus-plus-architecture.png){#fig-reinforce-pp}
