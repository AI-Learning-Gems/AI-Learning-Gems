...
![The RL infrastructure for DeepSeek-R1 training, showing the interaction between sampling (inference), reward computation, and policy update stages. Source: Guo et al. (2025), Figure 5.](images/rl-infra.png){#fig-rl-infra}
